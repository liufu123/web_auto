<<<<<<< HEAD:liufu_web_auto/pages/bodong_login_page.py
...
if __name__=='__main__':
    ...
    bodong = BodongLogin(driver)
    bodong.login()
    r = bodong.is_title("波洞星球boodo - 腾讯动漫画内容互动社区")
    print(r)
>>>>>>> be108a311f71f5245dfce3417c4c6362b3c46cf8:pages/bodong_login_page.py
