...
class Login(unittest.TestCase):
    ...
    def test01(self):
        self.log.info("禅道测试用例开始")
        self.a.login()
        self.log.info("开始登录禅道")
        name = self.a.get_name()
        self.log.info(u"获取的title内容：%s"%name)
        self.assertTrue(name == "退出")

    def test02(self):
        self.a.input_username()
        self.log.info("输入正确用户名")
        self.a.input_psw("111111")
        self.log.info("输入错误密码")
        self.a.login_button()
    ...
    def test03(self):
        ...
        self.log.info(u"获取的title内容：%s"%title)
